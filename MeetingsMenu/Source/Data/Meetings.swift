...
//    static let ComputerScience = nil
    ...
    static let Geometry = ZoomMeeting(title: "Геометрия", meetingID: "7266529370", meetingPassword: "k4WJH3")
    ...
    static let SpecialMaths = ZoomMeeting(title: "Специальная математика", meetingID: "7266529370", meetingPassword: "k4WJH3")
